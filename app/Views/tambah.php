...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg fixed-top">
        <div class="container-md ">
            ...
            <a class="navbar-brand" href="/" style="font-family:cursive;">Join Member</a>
                ...
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll ms-auto" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                            <li><a class="dropdown-item active" href="/tambah">Join Member</a></li>
    ...
    <div class="container-md-fluid bg-light pt-5">
        <div class="container pt-4">
            <h1 class="display-5 text-center text-dark pt-5" style="font-family:Verdana, Geneva, Tahoma, sans-serif;"><b>JOIN MEMBER DITAX PROGRAMMING</b></h1>
            <form action="/member/data" method="POST" class="p-4" enctype="multipart/form-data">
                <table class="table table-light">
                    <tr>
                        <td>Nama</td>
                        <td></td>
                        <td><input class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : '' ?>" type="text" placeholder="Nama Lengkap" name="nama">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td> <input class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : '' ?>" type="email" placeholder="contoh@gmail.com" name="email">
                            <div class="invalid-feedback">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td> <input class="form-control <?= ($validation->hasError('telepon')) ? 'is-invalid' : '' ?>" type="number" placeholder="08xxxxxxxxxx" name="telepon">
                            <div class="invalid-feedback">
                    ...
                    <tr>
                        ...
                        <td class="">
                            <div class="form-check ">
                                <input class="form-check-input" type="radio" name="gender" id="flexRadioDefault1" value="Laki-Laki" required>
                                <label class="form-check-label" for="flexRadioDefault1">
                                    Laki-laki
                                </label>
                            </div>
                            <div class="form-check ">
                                <input class="form-check-input" type="radio" name="gender" id="flexRadioDefault2" value="Perempuan" required>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <select class="form-select <?= ($validation->hasError('pekerjaan')) ? 'is-invalid' : '' ?>" aria-label="Default select example" name="pekerjaan">
                                <option selected>Pilih Pekerjaan</option>
                                <option value="PNS/TNI/POLISI">PNS/TNI/POLISI</option>
                                <option value="Pegawai Swasta">Pegawai Swasta</option>
                                <option value="Pelajar/Kuliah">Pelajar/Kuliah</option>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-floating">
                                <textarea class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : '' ?>" placeholder="Leave a comment here" id="floatingTextarea" name="alamat"></textarea>
                                <div class="invalid-feedback">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="mb-3">
                                ...
                                <input class="form-control <?= ($validation->hasError('foto')) ? 'is-invalid' : '' ?>" type="file" id="formFile" name="foto">
                                <div class="invalid-feedback">
                ...
                <div class="mb-3 form-check text-dark">
                    ...
                    <label class="form-check-label" for="validationFormCheck1">Menyetujui Ketentuan yang berlaku</label>
                    <div class="invalid-feedback">
                        Looks good!
                    </div>
                </div>
